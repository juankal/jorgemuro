...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const publications = [
    {
      id: 'paradoja-trabajador-senior',
      category: 'ai',
      date: '2026',
      readTime: { en: '2 min read', es: '2 min de lectura' },
      image: 'images/paradoja-trabajador-senior.svg',
      thumbnail: 'images/paradoja-trabajador-senior.svg',
      pdfLink: 'https://docs.google.com/document/d/1bxqLZMDXsmrF7qEDcRugL2MtRdqnlrtd/edit?usp=sharing',
      en: {
        tag: 'AI & Talent',
        title: "The Senior Worker's Paradox in the Age of AI",
        desc: 'Why generative AI can make senior experience more valuable, not less — a look at OECD evidence and the psychology of fluid vs. crystallized intelligence.',
        content: [
          "Public debate about workers over 50 usually collapses into a single variable: age. In the AI era, the variable that actually matters is different: how much of the work is automatable, and how much depends on judgment and institutional memory.",
          "Drawing on OECD evidence and the cognitive-psychology distinction between fluid intelligence (speed, short-term memory) and crystallized intelligence (judgment, accumulated knowledge), Dr. Muro shows why generative AI can make senior experience more valuable — not less.",
          "The article traces how early retirement became the 'natural' exit route during industrial restructuring, and proposes six practical measures for organizations to pair AI's speed with expert judgment instead of discarding it."
        ]
      },
      es: {
        tag: 'IA y Talento',
        title: 'La Paradoja del Trabajador Sénior en la Era de la IA',
        desc: 'Por qué la IA generativa puede volver más valiosa, no menos, la experiencia sénior: evidencia de la OCDE y la psicología de la inteligencia fluida y cristalizada.',
        content: [
          "La discusión pública sobre los trabajadores mayores de 50 años suele reducirse a la edad, cuando la variable decisiva en la era de la IA es otra: qué parte del trabajo es automatizable y qué parte depende del criterio y la memoria institucional.",
          "Apoyado en evidencia de la OCDE y en la distinción de la psicología cognitiva entre inteligencia fluida (velocidad, memoria de corto plazo) e inteligencia cristalizada (criterio, conocimiento acumulado), el Dr. Muro muestra por qué la IA generativa puede volver más valiosa —no menos— la experiencia sénior.",
          "El artículo repasa el origen histórico de la jubilación anticipada como 'salida natural' en las reestructuraciones industriales, y propone seis medidas prácticas para que las organizaciones combinen velocidad de IA con juicio experto en lugar de expulsarlo."
        ]
      }
    },
    {
      ...
      pdfLink: 'https://docs.google.com/document/d/1EnLLjtT21ILuz245UpgbE9mE1MrhMeOEYWGkuEsiPPQ/edit?tab=t.0',
      en: {
  ...
  const translations = {
    es: {
      ...
      footer_design: 'Desarrollado por',
  ...
  const updateDOMTranslations = () => {
    // Dynamic Meta Tags (Title & Description) for SEO
    if (translations[currentLang]['meta_title']) {
      document.title = translations[currentLang]['meta_title'];
    }
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc && translations[currentLang]['meta_description']) {
      metaDesc.setAttribute('content', translations[currentLang]['meta_description']);
    }
